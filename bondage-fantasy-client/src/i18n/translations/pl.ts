...
export const pl: ResourceLanguage = {
  translation: {
    ...
    "zoneCreation.tabs.placeNpc": "Umieść NPC",
    "zoneCreation.addNpc": "Dodaj NPC",
    "zoneCreation.placeNpc": "Umieść NPC",
    "zoneCreation.selectNpc": "Wybierz NPC",
    "zoneCreation.npcCannotBePlacedTwiceOnTheSameField":
      "NPC nie może być umieszony dwa razy na tym samym polu",
